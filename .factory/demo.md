...
- Sample: `examples/atlas-notes-export/` contains a realistic manifest, issue and pull-request excerpts, releases, workflow runs, and a license inventory.
...
- CLI reset: run `git-forge-exit-drill demo` again. The process-specific temporary demo directory is replaced.
